...
import com.marvin.springbootdeveloper1.dto.ArticleViewResponse;
...
public class BlogViewController {
    ...
    public String getArticle(@PathVariable Long id, Model model) throws IllegalAccessException {
    ...
    public String newArticle(@RequestParam(required = false) Long id, Model model) throws IllegalAccessException {
        if (id == null) {
